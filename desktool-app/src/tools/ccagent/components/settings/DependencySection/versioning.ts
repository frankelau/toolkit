// versioning.ts — 依赖版本工具
// 对齐 cc-gui DependencySection/versioning.ts
...
export const getRequestedVersion = (selectedVersion?: string): string | undefined => {
...
export const getVersionAction = ({
  installed, installedVersion, requestedVersion,
...
export const buildVersionOptions = ({
  availableVersions = [], fallbackVersions = [], installedVersion,
